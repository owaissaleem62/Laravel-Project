                        ...
                        <table class="table table-bordered table-hover mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="compare-column-productinfo">
                                        <div class="compare-pdoduct-image">
                                            ...
                                            <a href="/cart" class="ho-button ho-button-sm">
                                ...
                                <tr>
                                    <th>Product Name</th>
                                    <td>
                                        <h5 class="compare-product-name"><a href="/Single-Product">HP Pavilion</a></h5>
                                    </td>
                                    <td>
                                        <h5 class="compare-product-name"><a href="/Single-Product">HP Probook</a></h5>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Description</th>
